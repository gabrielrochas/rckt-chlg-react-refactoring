...
interface FoodProps {
  ...
  isAvailable: boolean;
  handleEditFood: (foodData: any) => void;
  handleDelete: (id: number) => void;
}

function Food({ food, isAvailable, handleEditFood, handleDelete}: FoodProps) {
    const [foodIsAvailable, setFoodIsAvailable] = useState(isAvailable)
    const foodData = food
